## WTNstreamEvents <span id="wtnstreamevents"></span>
...
| 方法 | 描述 |
| :-- | :-- |
| [onWTNPushStateChanged](#wtnstreamevents-onwtnpushstatechanged) | WTN 流发布结果回调。<br>调用 [startPushWTN](104478#wtnstream-startpushwtn) 发布 WTN 流后，结果通过此回调通知用户。 |
| [onWTNPlayStateChanged](#wtnstreamevents-onwtnplaystatechanged) | 调用 [startPlayWTN](104478#wtnstream-startplaywtn) 订阅 WTN 流后，结果通过此回调通知用户。 |
| [onWTNRemoteAudioStateChanged](#wtnstreamevents-onwtnremoteaudiostatechanged) | 调用 [startPlayWTN](104478#wtnstream-startplaywtn) 订阅 WTN 流后，音频订阅状态通过此回调通知用户。 |
| [onWTNRemoteVideoStateChanged](#wtnstreamevents-onwtnremotevideostatechanged) | 调用 [startPlayWTN](104478#wtnstream-startplaywtn) 订阅 WTN 流后，视频订阅状态通过此回调通知用户。 |
| [onWTNRemoteVideoStats](#wtnstreamevents-onwtnremotevideostats) | 调用 [startPlayWTN](104478#wtnstream-startplaywtn) 订阅 WTN 流，后将触发此回调，周期为 2s，包含视频统计信息。 |
| [onWTNRemoteAudioStats](#wtnstreamevents-onwtnremoteaudiostats) | 调用 [startPlayWTN](104478#wtnstream-startplaywtn) 订阅 WTN 流，后将触发此回调，周期为 2s，包含音频统计信息。 |
| [onWTNFirstRemoteVideoFrameDecoded](#wtnstreamevents-onwtnfirstremotevideoframedecoded) | WTN 流的视频首帧解码成功。<br>关于订阅 WTN 流，参看 [startPlayWTN](104478#wtnstream-startplaywtn)。 |
| [onWTNSEIMessageReceived](#wtnstreamevents-onwtnseimessagereceived) | 回调 WTN 流中包含的 SEI 信息。<br>调用 [startPlayWTN](104478#wtnstream-startplaywtn) 接口启动拉 WTN 流功能后，通过此回调收到 WTN 流中的 SEI 消息。 |
| [onWTNLocalStatsException](#wtnstreamevents-onwtnlocalstatsexception) | 本地 WTN 媒体流异常事件回调。 |
| [onWTNRemoteStatsException](#wtnstreamevents-onwtnremotestatsexception) | 远端 WTN 媒体流异常事件回调。 |

### onWTNPushStateChanged <span id="wtnstreamevents-onwtnpushstatechanged"></span> 
...
- **类型**
  ...
  ```ts
  (event: onWTNPushStateChangedEvent) => void
  ```
...
- **参数**
  ...
  - **event**
    ...
    类型: <code>[onWTNPushStateChangedEvent](104481#onwtnpushstatechangedevent)</code>

### onWTNPlayStateChanged <span id="wtnstreamevents-onwtnplaystatechanged"></span> 

调用 [startPlayWTN](104478#wtnstream-startplaywtn) 订阅 WTN 流后，结果通过此回调通知用户。

- **类型**

  ```ts
  (event: onWTNPlayStateChangedEvent) => void
  ```
...
- **参数**
  ...
  - **event**
    ...
    类型: <code>[onWTNPlayStateChangedEvent](104481#onwtnplaystatechangedevent)</code>

### onWTNRemoteAudioStateChanged <span id="wtnstreamevents-onwtnremoteaudiostatechanged"></span> 

调用 [startPlayWTN](104478#wtnstream-startplaywtn) 订阅 WTN 流后，音频订阅状态通过此回调通知用户。

- **类型**

  ```ts
  (event: onWTNRemoteAudioStateChangedEvent) => void
  ```
...
- **参数**
  ...
  - **event**
    ...
    类型: <code>[onWTNRemoteAudioStateChangedEvent](104481#onwtnremoteaudiostatechangedevent)</code>

### onWTNRemoteVideoStateChanged <span id="wtnstreamevents-onwtnremotevideostatechanged"></span> 

调用 [startPlayWTN](104478#wtnstream-startplaywtn) 订阅 WTN 流后，视频订阅状态通过此回调通知用户。

- **类型**

  ```ts
  (event: onWTNRemoteVideoStateChangedEvent) => void
  ```
...
- **参数**
  ...
  - **event**
    ...
    类型: <code>[onWTNRemoteVideoStateChangedEvent](104481#onwtnremotevideostatechangedevent)</code>

### onWTNRemoteVideoStats <span id="wtnstreamevents-onwtnremotevideostats"></span> 

调用 [startPlayWTN](104478#wtnstream-startplaywtn) 订阅 WTN 流，后将触发此回调，周期为 2s，包含视频统计信息。

- **类型**

  ```ts
  (event: onWTNRemoteVideoStatsEvent) => void
  ```
...
- **参数**
  ...
  - **event**
    ...
    类型: <code>[onWTNRemoteVideoStatsEvent](104481#onwtnremotevideostatsevent)</code>

### onWTNRemoteAudioStats <span id="wtnstreamevents-onwtnremoteaudiostats"></span> 

调用 [startPlayWTN](104478#wtnstream-startplaywtn) 订阅 WTN 流，后将触发此回调，周期为 2s，包含音频统计信息。

- **类型**

  ```ts
  (event: onWTNRemoteAudioStatsEvent) => void
  ```
...
- **参数**
  ...
  - **event**
    ...
    类型: <code>[onWTNRemoteAudioStatsEvent](104481#onwtnremoteaudiostatsevent)</code>

### onWTNFirstRemoteVideoFrameDecoded <span id="wtnstreamevents-onwtnfirstremotevideoframedecoded"></span> 
...
- **类型**
  ...
  ```ts
  (event: onWTNFirstRemoteVideoFrameDecodedEvent) => void
  ```
...
- **参数**
  ...
  - **event**
    ...
    类型: <code>[onWTNFirstRemoteVideoFrameDecodedEvent](104481#onwtnfirstremotevideoframedecodedevent)</code>

### onWTNSEIMessageReceived <span id="wtnstreamevents-onwtnseimessagereceived"></span> 
...
- **类型**
  ...
  ```ts
  (event: onWTNSEIMessageReceivedEvent) => void
  ```

- **注意**

  当 WTN 流中的多路视频流均包含有 SEI 信息时：
...
- **参数**
  ...
  - **event**
    ...
    类型: <code>[onWTNSEIMessageReceivedEvent](104481#onwtnseimessagereceivedevent)</code>

### onWTNLocalStatsException <span id="wtnstreamevents-onwtnlocalstatsexception"></span> 
...
- **类型**
  ...
  ```ts
  (event: onWTNLocalStatsExceptionEvent) => void
  ```
...
- **参数**
  ...
  - **event**
    ...
    类型: <code>[onWTNLocalStatsExceptionEvent](104481#onwtnlocalstatsexceptionevent)</code>

### onWTNRemoteStatsException <span id="wtnstreamevents-onwtnremotestatsexception"></span> 
...
- **类型**
  ...
  ```ts
  (event: onWTNRemoteStatsExceptionEvent) => void
  ```
...
- **参数**
  ...
  - **event**
    ...
    类型: <code>[onWTNRemoteStatsExceptionEvent](104481#onwtnremotestatsexceptionevent)</code>
...
| [onPublicStreamStats](#engineevents-onpublicstreamstats) | 调用 [startPlayPublicStream](104478#startplaypublicstream) 订阅 WTN 流，后将触发此回调，周期为 2s，包含各项统计信息。 |
| [onLocalStatsException](#engineevents-onlocalstatsexception) | SDK 监测到本地流异常事件回调，通常是由于网络或采集/播放设备等外部因素导致。异常事件不是错误，但是一般会引起通话质量问题。发生异常事件后，如果恢复正常，也会收到该回调。 |
| [onRemoteStatsException](#engineevents-onremotestatsexception) | SDK 监测到远端流异常事件回调，通常是由于网络或采集/播放设备等外部因素导致。异常事件不是错误，但是一般会引起通话质量问题。发生异常事件后，如果恢复正常，也会收到该回调。 |
| [onLocalAudioPropertiesReport](#engineevents-onlocalaudiopropertiesreport) | 调用 [enableAudioPropertiesReport](104478#enableaudiopropertiesreport) 后，根据设置的 interval 值，你会周期性地收到此回调，了解本地音频的瞬时信息。<br>本地音频包括使用 RTC SDK 内部机制采集的麦克风音频和屏幕音频。 |
| [onRemoteAudioPropertiesReport](#engineevents-onremoteaudiopropertiesreport) | 远端用户进房后，本地调用 [enableAudioPropertiesReport](104478#enableaudiopropertiesreport)，根据设置的 interval 值，本地会周期性地收到此回调，了解订阅的远端用户的瞬时音频信息。<br>远端用户的音频包括使用 RTC SDK 内部机制/自定义机制采集的麦克风音频和屏幕音频。 |
...
| [onPushPublicStreamResult](#engineevents-onpushpublicstreamresult) |  WTN 流发布结果回调。<br>调用 [startPushPublicStream](104478#startpushpublicstream) 发布 WTN 流后，结果通过此回调通知用户。 |
| [onPublicStreamSEIMessageReceived](#engineevents-onpublicstreamseimessagereceived) | 回调 WTN 流中包含的 SEI 信息。<br>调用 [startPlayPublicStream](104478#startplaypublicstream) 接口启动拉 WTN 流功能后，通过此回调收到 WTN 流中的 SEI 消息。 |
| [onFirstPublicStreamVideoFrameDecoded](#engineevents-onfirstpublicstreamvideoframedecoded) |  WTN 流的视频首帧解码成功。<br>关于订阅 WTN 流，参看 [startPlayPublicStream](104478#startplaypublicstream)。 |
| [onFirstPublicStreamAudioFrameDecoded](#engineevents-onfirstpublicstreamaudioframedecoded) |  WTN 流的音频首帧解码成功。<br>关于订阅 WTN 流，参看 [startPlayPublicStream](104478#startplaypublicstream)。 |
| [onFirstPublicStreamVideoFrameRendered](#engineevents-onfirstpublicstreamvideoframerendered) |  WTN 流的首帧视频渲染成功。<br>关于订阅 WTN 流，参看 [startPlayPublicStream](104478#startplaypublicstream)。 |
...
| [onPlayerVisibility](#engineevents-onplayervisibility) | 播放器可见性变化事件，每 30 秒触发一次。 |
...
当摄像头连接状态发生改变时，会触发该回调。例如因设备拔插导致设备断开/连接。
...
音频媒体设备（即麦克风、扬声器）连接状态发生改变时，会触发该回调。例如因设备拔插导致设备断开/连接。
...
调用 [startPlayPublicStream](104478#startplaypublicstream) 订阅 WTN 流，后将触发此回调，周期为 2s，包含各项统计信息。

- **已弃用**

  since 4.65, use [onWTNRemoteVideoStats](104479#wtnstreamevents-onwtnremotevideostats) and [onWTNRemoteAudioStats](104479#wtnstreamevents-onwtnremoteaudiostats) instead.
...
### onLocalStatsException <span id="engineevents-onlocalstatsexception"></span> 

SDK 监测到本地流异常事件回调，通常是由于网络或采集/播放设备等外部因素导致。异常事件不是错误，但是一般会引起通话质量问题。发生异常事件后，如果恢复正常，也会收到该回调。

- **类型**

  ```ts
  (exception: LocalStatsException) => void
  ```
...
- **参数**
  ...
  - **exception**
    ...
    类型: <code>[LocalStatsException](104481#localstatsexception)</code>

### onRemoteStatsException <span id="engineevents-onremotestatsexception"></span> 

SDK 监测到远端流异常事件回调，通常是由于网络或采集/播放设备等外部因素导致。异常事件不是错误，但是一般会引起通话质量问题。发生异常事件后，如果恢复正常，也会收到该回调。

- **类型**

  ```ts
  (exception: RemoteStatsException) => void
  ```
...
- **参数**
  ...
  - **exception**
    ...
    类型: <code>[RemoteStatsException](104481#remotestatsexception)</code>

### onLocalAudioPropertiesReport <span id="engineevents-onlocalaudiopropertiesreport"></span> 

调用 [enableAudioPropertiesReport](104478#enableaudiopropertiesreport) 后，根据设置的 interval 值，你会周期性地收到此回调，了解本地音频的瞬时信息。
...
远端用户进房后，本地调用 [enableAudioPropertiesReport](104478#enableaudiopropertiesreport)，根据设置的 interval 值，本地会周期性地收到此回调，了解订阅的远端用户的瞬时音频信息。
...
Token 订阅权限过期时触发该回调，调用 [updateToken](104478#updatetoken) 更新 Token。
...
### onPushPublicStreamResult <span id="engineevents-onpushpublicstreamresult"></span> 
 ...
 WTN 流发布结果回调。
调用 [startPushPublicStream](104478#startpushpublicstream) 发布 WTN 流后，结果通过此回调通知用户。
...
回调 WTN 流中包含的 SEI 信息。
调用 [startPlayPublicStream](104478#startplaypublicstream) 接口启动拉 WTN 流功能后，通过此回调收到 WTN 流中的 SEI 消息。

- **已弃用**

  since 4.65, use [onWTNSEIMessageReceived](104479#wtnstreamevents-onwtnseimessagereceived) instead.
...
### onFirstPublicStreamVideoFrameDecoded <span id="engineevents-onfirstpublicstreamvideoframedecoded"></span> 
 ...
 WTN 流的视频首帧解码成功。
关于订阅 WTN 流，参看 [startPlayPublicStream](104478#startplaypublicstream)。

- **已弃用**

  since 4.65, use [onWTNFirstRemoteVideoFrameDecoded](104479#wtnstreamevents-onwtnfirstremotevideoframedecoded) instead.
...
- **已弃用**
  ...
  since 4.65, use [onWTNRemoteVideoStateChanged](104479#wtnstreamevents-onwtnremotevideostatechanged) instead.
...
### onPlayerVisibility <span id="engineevents-onplayervisibility"></span> 

播放器可见性变化事件，每 30 秒触发一次。

- **类型**

  ```ts
  (e: PlayerVisibility[]) => void
  ```
...
- **参数**
  ...
  - **e**
    ...
    类型: <code>[PlayerVisibility](104481#playervisibility)[]</code>

    播放器可见性信息数组，包含当前所有播放器的 ID、用户 ID 以及可见性状态等信息。